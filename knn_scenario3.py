...
# define dataset
data = read_csv('../Data/Scenario3.csv', header=0, index_col=0, parse_dates=[0], infer_datetime_format=True)
#split into test and train
X = data.values
n_test = 12000
train, test = X[0:-n_test], X[-n_test:]

df = series_to_supervised(train, 12)
df_test = series_to_supervised(test, 12)
#get X and y
